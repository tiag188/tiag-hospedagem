...
jQuery(document).ready(function($) {
	...
	$('#counter-1').animateNumber({ number: 11 }, 2000 );
	$('#counter-2').animateNumber({ number: 140 }, 2000 );
	$('#counter-3').animateNumber({ number: 80 }, 2000 );
	},{accX: 0, accY: -200});



	$('#expand-counters').appear(function() {
	$('#expand-counter-1').animateNumber({ number: 16 }, 3000 );
	$('#expand-counter-2').animateNumber({ number: 11 }, 3000 );
	$('#expand-counter-3').animateNumber({ number: 4 }, 3000 );
	},{accX: 0, accY: -200});
...
-----------------------------------------------------------*/
	...
	$('.expand-1').css('width', '16%');
	$('.expand-2').css('width', '11%');
	$('.expand-3').css('width', '4%');
	},{accX: 0, accY: -70});
});
...
var clock;
	...
	futureDate = new Date("May 17, 2021 00:00:00")
